        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 items-start">
          ...
          <div className="lg:col-span-5 space-y-4">
            ...
            <div className="grid grid-cols-4 gap-3">
              ...
              >
                <img src="https://images.unsplash.com/photo-1503951914875-452162b0f3f1?q=80&w=600&auto=format&fit=crop" alt="detail 2" className="w-full h-full object-cover" />
              </button>
              <button 
              ...
              >
                <img src="https://images.unsplash.com/photo-1621605815971-fbc98d665033?q=80&w=600&auto=format&fit=crop" alt="detail 3" className="w-full h-full object-cover" />
              </button>
              <button 
              ...
              >
                <img src="https://images.unsplash.com/photo-1596178065887-1198b6148b2b?q=80&w=600&auto=format&fit=crop" alt="detail 4" className="w-full h-full object-cover" />
              </button>
            </div>
          </div>
