...
export default function DeliveryShippingPolicy() {
  const sections = [
    ...
    },
    {
      num: "3",
      title: "مدة التوصيل",
      content: "تختلف مدة تجهيز وتوصيل الطلب من طلب إلى آخر، وقد تتأثر بعدة عوامل مثل توفر المنتجات، وموقع العميل، وطريقة التوصيل المستخدمة.\n\nسيتم توضيح أي معلومات متعلقة بالتوصيل للعميل عند الحاجة قبل أو أثناء إتمام الطلب."
    },
    {
      num: "4",
      title: "رسوم التوصيل",
